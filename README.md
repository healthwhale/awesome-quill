...
- [quill-mention](https://github.com/quill-mention/quill-mention) - @mentions for the Quill rich text editor
...
- [Quill Audio resize](https://github.com/duzhenlin/duzhenlin-quill-audio-resize-module) - A module for Quill rich text editor to allow audio to be resized.
- [Vue Quill export content](https://gywgithub.github.io/vue-quill-drag-drop/#/QuillFormats) - example quill vue editor with export to HTML or MS DOC format 
- [Vue Quill drag and drop](https://github.com/gywgithub/vue-quill-drag-drop) - drag and drop into the editor
- [collaborative editing](https://github.com/danfuzz/bayou) - Collaborative document editing, with Quill-based front end
- [matters editor based on quill](https://github.com/thematters/matters-editor) - This rich text editor is based on three amazing projects Quill, react-quill and Tippy.js. This editor has been used in a real production called Matters, a writing platform built on top of IPFS. Currently, we're pulling it out as a standalone package, so there will be some big changes in the following
- [quill mobile](https://github.com/juniorise/spooky-mb) - not sure if they are refering to quill.js
- [Quill better table with delta format](https://github.com/soccerloway/quill-better-table) - A module for better table in Quill, more useful features are supported. There is a list of features below. Thanks quilljs for its awesome extensibility. Hope that quill-better-table could help you.
- [quill examples and resources](https://github.com/loagit/Quill-Examples-and-FAQ) - This repository is designed to serve as an informational medium for anyone learning to use the rich text editor Quill JS.
- [quill react mentions](https://github.com/zenoamaro/react-quill/issues/324) - quill react mentions
- [Quill and AI integration gpt2 pytorch ](https://github.com/andfanilo/writing-with-gpt2) - Reproducing "Writing with Transformer" demo, using aitextgen/FastAPI in backend, Quill/React in frontend
- [MD to Quill Delta](https://github.com/volser/md-to-quill-delta) - 
- [Quill Spellcheck](https://github.com/zaffnet/quill_spellcheck_demo) - Spellcheck in a WYSIWYG Editor. I have modified the Tooltip provided by Quill to suggest words.
- [Quill ImageResize](https://github.com/kensnyder/quill-image-resize-module) - A module for Quill rich text editor to allow images to be resized.
